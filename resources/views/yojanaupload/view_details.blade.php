...
<div class="container ward_anugaman_page">
    <div class="card" style="background-color:white;border-radius:5px;">
        <div class="card-header heading"><span style="margin-left:120px;">वडा स्तरीय अनुगमन विवरण</span> <span
                style="margin-left:80px;">
                <a href="{{ route('yojanaupload.printAlldetails', ['darta_no' => $yojana['id']])}}">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered striped">
                        ...
                        <span style="margin-left:25px;"><label>वडा नं: <u>{{ $yojana['p_ward']}}</u>
                            </label></span>
                        <thead>
                            <tr>
                                <th>सी.नं</th>
...
$i = 1; // Initialize counter outside the loop
    ...
    if ($wa['post_name'] == 1) {
        ...
        <div class="card-header heading"><span style="margin-left:120px;">नगर स्तरीय अनुगमन विवरण</span> <span
                style="margin-left:80px;">
